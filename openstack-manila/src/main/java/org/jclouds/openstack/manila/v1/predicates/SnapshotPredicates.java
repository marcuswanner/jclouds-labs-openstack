 ...
 * <pre>
 * {@code
 * Snapshot snapshot = snapshotApi.create(shareId);
...
public class SnapshotPredicates {
   ...
   public static Predicate<Snapshot> awaitAvailable(SnapshotApi snapshotApi) {
      StatusUpdatedPredicate statusPredicate = new StatusUpdatedPredicate(snapshotApi, Share.Status.AVAILABLE);
   ...
   public static Predicate<Snapshot> awaitStatus(SnapshotApi snapshotApi, Share.Status status, long maxWaitInSec,
         long periodInSec) {
   ...
   private static class StatusUpdatedPredicate implements Predicate<Snapshot> {
      ...
      public StatusUpdatedPredicate(SnapshotApi snapshotApi, Share.Status status) {
