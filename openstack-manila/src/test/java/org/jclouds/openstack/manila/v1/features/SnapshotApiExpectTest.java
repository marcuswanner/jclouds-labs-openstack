...
public class SnapshotApiExpectTest extends org.jclouds.openstack.manila.v1.internal.BaseManilaApiExpectTest {
   private DateService dateService = new SimpleDateFormatDateService();

   public void testListSnapshotsInDetail() {
      URI endpoint = URI.create("http://172.16.0.1:8786/v1/50cdb4c60374463198695d9f798fa34d/snapshots/detail");
      ...
      assertEquals(snappy.getShareId(), "ea6f70ef-2784-40b9-9d14-d7f33c507c3f");
      assertEquals(snappy.getStatus(), Share.Status.AVAILABLE);
   ...
   public void testGetSnapshot() {
      URI endpoint = URI.create("http://172.16.0.1:8786/v1/50cdb4c60374463198695d9f798fa34d/snapshots/67d03df1-ce5d-4ba7-adbe-492ceb80170b");
      SnapshotApi api = requestsSendResponses(
            keystoneAuthWithUsernameAndPasswordAndTenantName,
            responseWithKeystoneAccess,
            authenticatedGET().endpoint(endpoint).build(),
   ...
   public void testCreateSnapshot() {
      URI endpoint = URI.create("http://172.16.0.1:8786/v1/50cdb4c60374463198695d9f798fa34d/snapshots");
      SnapshotApi api = requestsSendResponses(
            keystoneAuthWithUsernameAndPasswordAndTenantName,
            responseWithKeystoneAccess,
   ...
   public void testCreateSnapshotShareNotFoundFail() {
      URI endpoint = URI.create("http://172.16.0.1:8786/v1/50cdb4c60374463198695d9f798fa34d/snapshots");
      SnapshotApi api = requestsSendResponses(
            keystoneAuthWithUsernameAndPasswordAndTenantName,
            responseWithKeystoneAccess,
   ...
   public void testCreateSnapshotShareIllegalStateFail() {
      URI endpoint = URI.create("http://172.16.0.1:8786/v1/50cdb4c60374463198695d9f798fa34d/snapshots");
      SnapshotApi api = requestsSendResponses(
            keystoneAuthWithUsernameAndPasswordAndTenantName,
            responseWithKeystoneAccess,
            ...
            HttpResponse.builder()
                  ...
                  .payload(Payloads.newByteSourcePayload(ByteSource
                        .wrap("{\"badRequest\": {\"message\": \"Invalid share: must be available\", \"code\": 400}}"
                              .getBytes())))
                  .build()
      ).getSnapshotApi("RegionOne");
   ...
   public void testDeleteSnapshotIllegalStateFail() {
      ...
      SnapshotApi api = requestsSendResponses(
            ...
            HttpResponse.builder()
                  .statusCode(400)
                  .payload(Payloads.newByteSourcePayload(ByteSource
                        .wrap("{\"badRequest\": {\"message\": \"Invalid share: Share Snapshot status must be available or error\", \"code\": 400}}"
                              .getBytes())))
                  .build()
      ).getSnapshotApi("RegionOne");
   ...
   protected Snapshot testSnapshotCreate() {
      return Snapshot.builder()
            ...
            .shareId("ea6f70ef-2784-40b9-9d14-d7f33c507c3f")
            .description("jclouds test snapshot")
   ...
   protected Snapshot testSnapshotDetailed() {
      return Snapshot.builder()
            ...
            .created(dateService.iso8601DateParse("2012-11-02T16:23:27.000000"))
            .proto("NFS")
            .export("192.168.33.10:/snapshots/ea6f70ef-2784-40b9-9d14-d7f33c507c3f_67d03df1-ce5d-4ba7-adbe-492ceb80170b")
            .build();
   }
}
